...
while(cap.isOpened()):
    ...
    #create bounding rectangle around the biggest contour 
    x,y,w,h = cv2.boundingRect(cnt)
    cv2.rectangle(crop_img, (x,y), (x+w,y+h),(0,0,255),0)

    #finding convex hull ,that is the biggest convex hull
    ...
    if count_defects==0:
        ...
        cv2.putText(img,"EMPTY", (50,50),cv2.FONT_HERSHEY_SIMPLEX,2 ,2) 
